...
const Head = ({
  ...
  return (
    <section
      className="w-full sm:h-[40vh] h-[35vh] bg-cover bg-center py-16 px-4 md:px-10 text-white shadow-4xl mt-16 md:mt-20"
      style={{ backgroundImage: `url(${image})` }}
    >
      <div className="md:pl-30 max-w-7xl mx-auto flex flex-col items-center justify-center md:items-start text-center md:text-left gap-4 h-full">
